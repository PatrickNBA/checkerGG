...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>NEVER BROKEN AGAIN</title>
...
<div class="container mt-4" style="margin-bottom: 100px;">
    ...
    <div class="text-center ">
        <h1 class="text-light"><b>CHK</b> NBA</h1>
        <div class="text-center ">
        <h0 class="text-light"><b>MONTANA MEU AMOR</h0>
    </div>
        <h class="text-light"><b>CHECKER GG</h>
    ...
    <center>
        ...
        <div class="badge badge-danger badge-pill" style="padding: 10px 10px;margin: 5px;">
            ...
            <span style="font-size: 15px;"> Queimadas</span>
    ...
    <center>
        <div class="text-center text-light mt-3">
            <h4 class="text-light" id="status_ccs">@nbapatrick...</h4>
        </div>
    </center>
